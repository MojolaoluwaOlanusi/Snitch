...
/**
 * initRealtime: initialize Socket.IO on an existing HTTP server.
 * - Attaches auth middleware
 * - Configures Redis adapter (if REDIS_URL or USE_REDIS_ROOMS)
 * - Uses RedisRoomStore when Redis is available
 */
