    ...
    const renderLinks = (mobile = false) => (
        <div className="space-y-1">
            {links.map((link) => {
                ...
                // 🔥 New styling: unselected = darker variant with shadow, selected = blue
                let buttonClass = 'btn w-full justify-start rounded-lg transition-all duration-200 border-0 shadow-none';
                ...
                <div className="rounded-lg bg-base-100 p-4 sticky top-0 left-0 h-screen flex flex-col w-full">
                    ...
                    <div className="space-y-2">
                        {links.map((link) => {
                            ...
                            let buttonClass = 'btn w-full justify-center lg:justify-start rounded-lg transition-all duration-200 border-0 shadow-none';
