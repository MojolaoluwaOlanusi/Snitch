                ...
                <div className="relative w-full h-full">
                            ...
                            {callAnswered ? (
                                <div className="mt-6 w-64">
                                    <div className="flex items-center justify-center gap-2">
                                        <Mic className={`w-5 h-5 ${isMicMuted ? 'text-red-500' : 'text-white'}`} />
                    ...
                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2 md:gap-3 bg-black/40 backdrop-blur-sm rounded-full px-3 py-2 md:px-6 md:py-3 flex-wrap justify-center">
                        ...
                        {isVideoMode && (
                            <button
                                onClick={flipCamera}
                                className="p-2 md:p-3 rounded-full bg-white/20 text-white hover:bg-white/30"
                            >
                        ...
                        <button
                            onClick={endCall}
                            className="p-2 md:p-3 rounded-full bg-red-500 text-white hover:bg-red-600"
                        >
